...
- **2026-08-17 — v1.6.12**: select several lines and press Tab to indent them all, Shift+Tab to unindent — handy for nesting a code block under a numbered list item. Tab previously replaced the whole selection with two spaces, deleting the highlighted lines. New `⇥` and `⇤` toolbar buttons do the same thing.
