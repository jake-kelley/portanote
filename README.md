...
- **To-Do list** (a standalone view, independent of your notes): add / complete / reorder (drag) / delete tasks and clear completed ones. From any note, the **☑ toolbar button** creates a task linked back to that note — click the 🔗 chip on the task to jump to it.
